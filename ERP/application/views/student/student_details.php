...
<div class="row">
    ...
    <div class="row">
    <fieldset>
                <legend><b style="font-size:26px;">Upload Excell File</b></legend>
                <form name="emp_dtls" action="<?php echo base_url();?>index.php/student/student_details/submit_details_file" method="post" enctype="multipart/form-data">
                <div class="input-group-inline">
                <label for="">Select Stream</label>
                <select name="txt_minor" id="txt_minor">
    ...
    <?php } ?>
          ...
          <!--   <div id="subj_details" style="display:none;">
            <div class="input-group-inline">
...
<div class="title_head">Student Details</div><hr />
<div class="container">
    <div class="row">
        <a href="#" onclick="getCheckedCheckboxesFor()">Print ID Card</a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="getCheckedCheckboxesForLibrary()">Print Library Card</a>
    </div>
</div>
<div class="container">
    <div class="row-full">
            ...
            <div class="box">
                <span> <input type="checkbox" name="students" value="<?php echo $sval['stud_id'];?>" /> <?php echo $sval['name'];?></span>
...
for (var i=0; i<checkboxes.length; i++) {
 ...
 if(selected == '') {
    ...
    window.open('http://localhost/dumkal/ERP/index.php/student/Student_details/student_id_card/'+btoa(encodeURIComponent(selected)),'_blank');
 }
} 
...
for (var i=0; i<checkboxes.length; i++) {
 ...
 if(selected == '') {
   ...
   // window.open('billing_multiple.php?bill_id='+selected,'_blank');
    window.open('http://localhost/dumkal/ERP/index.php/student/Student_details/student_lid_card/'+btoa(encodeURIComponent(selected)),'_blank');
 }
}         
</script>
</body>
