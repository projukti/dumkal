...
<form name="news" id="news" action="<?php echo base_url();?>admin.php/dashboard/update_guest" method="post" enctype="multipart/form-data" onsubmit="return validate_guest()">
<input type="hidden" name="category" id="category" value="<?php echo $data[0]['gid'];?>" />
  <div class="row" id="about_contant" style="display:block;">
    ...
    <tr>
        <td>Guest picture Uploaded</td>
         <td class="center">
        
                   <img src="<?php echo base_url();?>guest/<?php echo $data[0]['image'];?>" width="130" height="120">
    ...
    <tr>
        ...
        <td class="center">
        <textarea name="bdesc" id="inputSuccess1" class="desc"><?php echo $data[0]['content'];?></textarea></td>
