...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="488" align="center" valign="middle" bgcolor="#FFFFFF"><table width="781" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
      <tr>
        <td height="40" align="center" valign="middle" bgcolor="#000000"><span class="style5">STEP - 4 : Application for <?php echo $_SESSION['session_stream'];?> (2015-16)</span></td>
      </tr>
      <tr>
  ...
  <option value="1950">1950</option>
         ...
         <tr>
          ...
          <tr>
            ...
            <td height="40" align="left" valign="middle" class="style28">:</td>
            <td height="40" align="left" valign="middle" class="style28"><input name="txt_last_exam" type="text" style="width:228px; height:20px; outline:none; padding:4px;" value="<?php echo $_SESSION['session_last_exam_pass'];?>" readonly/></td>
          </tr>
         ...
         <tr>
          ...
          <tr>
            ...
            <td height="40" colspan="3" align="left" valign="top" class="style28 style30">Applicant may choose Elective Subject(s) as per his/her choice. But finally the said subject(s) will be offered to him/her on availability or eligibility at the time of admission.<br/>You Have Choosen <?php echo $_SESSION['session_honours_sub'];?> and Suggestions are below.</td>
            </tr>
          <tr>
            <td height="40" align="center" valign="middle" class="style28">&nbsp;</td>
            <td height="40" colspan="3" align="left" valign="middle" class="style28"><table width="535" border="0" align="left" cellpadding="0" cellspacing="2">
              ...
              <tr>
                ...
                <td align="center" valign="middle" bgcolor="#FFCC99">
                  <label>
                    <input type="radio" name="txt_subj_grp" id="txt_subj_grp" value="<?php echo $sub_group['grp_id'];?>"/>
                    </label>
                                </td>
              </tr>
              <?php } ?>
